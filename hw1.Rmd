...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **John King**. I am a *Software Engineering* major in my Junior year. 
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: Healthcare Data Analysts can work for hospitals to help provide a better service for the patients. A related field would be testing drugs for healthcare use. Finally, a similar data analyst might analyze data related to nutrition to find how different diets affect people. [Website description of Healthcare Data Analysts](https://himt.wisconsin.edu/experience-uw-himt/healthcare-data-analyst/) ![Image of compiled data](hw1.png)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I believe that I will be most interested in the health topic. There are a lot of different people who's bodies respond to the same stimulus in completely different ways, so it's interesting to me to see how certain things affect a large number of people.
